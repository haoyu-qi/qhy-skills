...
1. Use ZenTao CLI for all ZenTao reads and writes.
...
7. If subtasks are requested, prefer requirement-document-based decomposition over generic subtasks.
8. After writing to ZenTao, verify by listing the execution tasks and summarize task IDs, names, owners, and deadlines.
...
If the user provides requirement documents, requirement links, requirement IDs, or a feature list, read that material and decompose subtasks from it.
