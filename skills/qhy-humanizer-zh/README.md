...
git clone https://github.com/op7418/Humanizer-zh.git ~/.claude/skills/qhy-humanizer-zh
```
...
3. 确保文件夹结构如下：
   ```
   ~/.claude/skills/qhy-humanizer-zh/
   ├── SKILL.md       # 技能定义文件（中文版）
   └── README.md      # 说明文档
   ```
...
```
/qhy-humanizer-zh 请人性化 article.md 文件中的内容
```
